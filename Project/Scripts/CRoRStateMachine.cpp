...
template <class T>
void CRoRStateMachine<T>::ReflectState(CGameObject* from, int index, string name)
{
}

template <class T>
void CRoRStateMachine<T>::LogState(int index)
{
}

template <class T>
void CRoRStateMachine<T>::LogAllStates()
{
}
...
template <class T>
void CRoRStateMachine<T>::StateManager::ForceSetCurState(int _ToState)
{
