...
CScript * CScriptMgr::GetScript(const wstring& _strScriptName)
{
	...
	if (L"CSpawnPhysXC" == _strScriptName)
		return new CSpawnPhysXC;
	return nullptr;
}
...
CScript * CScriptMgr::GetScript(UINT _iScriptType)
{
	...
	case (UINT)SCRIPT_TYPE::BLADEAFTERIMAGE:
		return new CBladeAfterImage;
		break;
	case (UINT)SCRIPT_TYPE::SPAWNPHYSXC:
		return new CSpawnPhysXC;
		break;
	}
	return nullptr;
...
const wchar_t * CScriptMgr::GetScriptName(CScript * _pScript)
{
	...
	case SCRIPT_TYPE::SPAWNPHYSXC:
		return L"CSpawnPhysXC";
		break;
